    ...
    const columns=[
        ...
        },
        {
            ...
            renderCell: (element: any) => {
                ...
                return(
                    <Stack direction='column' justifyContent='center' alignItems='center' width={120}>
                        <Typography fontSize={16} fontWeight={400} sx={{ wordBreak: "break-word" }}>
...
return<div>
    <Stack direction='column' spacing={3}>
        ...
        getRowId={(row) => ("CurrID" ? row["CurrID"] : row["CurrID"])}
      ...
      />
        ...
        <Stack direction='column' justifyContent='center' alignItems='center' height={128} width='100%' spacing={1}>
            <Typography fontSize={16} fontWeight={600}>
                Үлдэгдэл
            </Typography>

            <Typography fontSize={36} fontWeight={700} color='#7F49E5'>
            {data && data.length > 0
                        ? formatPrice(
                              data.reduce(
                                  (acc: any, obj: any) =>
