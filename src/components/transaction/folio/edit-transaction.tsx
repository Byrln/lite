...
export default function EditFolioTransaction({FolioID, CurrID, TypeID, handleModal, TransactionID}:any){
...
adapterLocale={mn}
>
<Stack direction='column' justifyContent='center' width='100%' spacing={2}>
...
<Stack direction='row' spacing={3}>
  ...
  {  
(amount==amount2)?<div></div>:<div>
<Typography>
        {amount2.toLocaleString()}{currency2}
    </Typography>
</div>
    }
