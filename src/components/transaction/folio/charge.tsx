    ...
    return <div>
        ...
        <Stack direction='column' spacing={1}>
            <Stack direction='row' spacing={2}  alignItems='center'>
                ...
                <TextField disabled value={ moment(workingDate).format("YYYY-MM-DD")}/>
                ...
                <DateTimePicker disabled={enableDate} value={setedDate} onChange={(newValue)=> setSetedDate(newValue)}   renderInput={(params) => ( <TextField {...params}/> )}/>
