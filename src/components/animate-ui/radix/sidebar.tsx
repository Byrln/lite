  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={cn(
          'relative w-(--sidebar-width) bg-transparent transition-[width] duration-400 ease-&lsqb;cubic-bezier(0.7,-0.15,0.25,1.15)&rsqb;',
      ...
      <div
        ...
        className={cn(
          'fixed inset-y-0 z-10 hidden h-svh w-(--sidebar-width) transition-[left,right,width] duration-400 ease-&lsqb;cubic-bezier(0.75,0,0.25,1)&rsqb; md:flex',
          side === 'left'
