                ...
                <Grid container spacing={1}>
                  ...
                  <Grid item xs={6}>
                    <TextField
                      ...
                      error={!!errors.BaseAdult?.message}
                      helperText={
                        errors.BaseAdult?.message as string}
                    />
                  </Grid>
                  <Grid item xs={6}>
                    <TextField
                      ...
                      error={!!errors.MaxAdult?.message}
                      helperText={
                        errors.MaxAdult?.message as string}
                    />
                  </Grid>
                  <Grid item xs={6}>
                    <TextField
                      ...
                      error={!!errors.BaseChild?.message}
                      helperText={
                        errors.BaseChild?.message as string}
                    />
                  </Grid>
                  <Grid item xs={6}>
                    <TextField
            ...
            <Card className="mt-3">
              <CardContent>
                <Typography
                  ...
                  className="mb-3"
                >
                  {intl.formatMessage({ id: "TextBooking" })}
                </Typography>
                ...
                <Grid container spacing={1}>
                  <Grid item xs={12}>
                    <TextField
                      ...
                      id="BookingDescription"
                      label={intl.formatMessage({
                        id: "TextBriefDescription(OnlineOrder)",
                ...
                <AmenitySelect
                  ...
                  customTitle={intl.formatMessage({
                    id: "TextRoomAmenity(OnlineBooking)",
                  })}
                  setEntity={setEntity}
                />
              </CardContent>
