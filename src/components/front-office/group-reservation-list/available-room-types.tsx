    ...
    return (
      <TableContainer className="bg-white rounded-md">
        <Table size="small">
          <TableHead>
            <TableRow>
              <TableCell sx={{ fontWeight: 'bold', fontSize: '0.7rem', color: "white" }}>№</TableCell>
              <TableCell sx={{ fontWeight: 'bold', fontSize: '0.7rem', color: "white" }}>
          ...
          <TableBody>
            {data.map((row: any, index: number) => (
              <TableRow key={row.RoomTypeID || index}>
                ...
                <TableCell sx={{ fontSize: '0.7rem' }}>{row.RoomTypeFullName}</TableCell>
                <TableCell sx={{ fontSize: '0.7rem' }}>{row.AvailableRooms}</TableCell>
              </TableRow>
            ))}
          </TableBody>
        </Table>
